...
enum opt_code
{
  ...
  OPT_list = 1596,                           /* -list */
  OPT_m128bit_long_double = 1597,            /* -m128bit-long-double */
  OPT_m16 = 1598,                            /* -m16 */
  OPT_m32 = 1599,                            /* -m32 */
  OPT_m3dnow = 1600,                         /* -m3dnow */
  OPT_m3dnowa = 1601,                        /* -m3dnowa */
  OPT_m64 = 1602,                            /* -m64 */
  OPT_m80387 = 1603,                         /* -m80387 */
  OPT_m8bit_idiv = 1604,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1605,             /* -m96bit-long-double */
  OPT_mabi_ = 1606,                          /* -mabi= */
  OPT_mabm = 1607,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1608,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1609,                 /* -maddress-mode= */
  OPT_madx = 1610,                           /* -madx */
  OPT_maes = 1611,                           /* -maes */
  OPT_malign_data_ = 1612,                   /* -malign-data= */
  OPT_malign_double = 1613,                  /* -malign-double */
  OPT_malign_functions_ = 1614,              /* -malign-functions= */
  OPT_malign_jumps_ = 1615,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1616,                  /* -malign-loops= */
  OPT_malign_stringops = 1617,               /* -malign-stringops */
  OPT_mandroid = 1618,                       /* -mandroid */
  ...
  OPT_mbionic = 1642,                        /* -mbionic */
  OPT_mbmi = 1643,                           /* -mbmi */
  OPT_mbmi2 = 1644,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1645,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1646,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1647,                    /* -mcet-switch */
  OPT_mcld = 1648,                           /* -mcld */
  OPT_mcldemote = 1649,                      /* -mcldemote */
  OPT_mclflushopt = 1650,                    /* -mclflushopt */
  OPT_mclwb = 1651,                          /* -mclwb */
  OPT_mclzero = 1652,                        /* -mclzero */
  OPT_mcmodel_ = 1653,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1654, */                    /* -mcpu= */
  OPT_mcrc32 = 1655,                         /* -mcrc32 */
  OPT_mcx16 = 1656,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1657,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1658,            /* -mdump-tune-features */
  OPT_menqcmd = 1659,                        /* -menqcmd */
  OPT_mf16c = 1660,                          /* -mf16c */
  OPT_mfancy_math_387 = 1661,                /* -mfancy-math-387 */
  OPT_mfentry = 1662,                        /* -mfentry */
  OPT_mfentry_name_ = 1663,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1664,               /* -mfentry-section= */
  OPT_mfma = 1665,                           /* -mfma */
  OPT_mfma4 = 1666,                          /* -mfma4 */
  OPT_mforce_drap = 1667,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1668,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1669,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1670,                       /* -mfpmath= */
  OPT_mfsgsbase = 1671,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1672,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1673, */              /* -mfused-madd */
  OPT_mfxsr = 1674,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1675,             /* -mgeneral-regs-only */
  OPT_mgfni = 1676,                          /* -mgfni */
  OPT_mglibc = 1677,                         /* -mglibc */
  ...
  OPT_mmwaitx = 1706,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1707,            /* -mno-align-stringops */
  OPT_mno_default = 1708,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1709,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1710,                  /* -mno-push-args */
  OPT_mno_red_zone = 1711,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1712,                       /* -mno-sse4 */
  ...
  OPT_mpku = 1721,                           /* -mpku */
  OPT_mpopcnt = 1722,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1723, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1724,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1725,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1726,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1727,                        /* -mprfchw */
  OPT_mptwrite = 1728,                       /* -mptwrite */
  OPT_mpush_args = 1729,                     /* -mpush-args */
  OPT_mrdpid = 1730,                         /* -mrdpid */
  OPT_mrdrnd = 1731,                         /* -mrdrnd */
  OPT_mrdseed = 1732,                        /* -mrdseed */
  OPT_mrecip = 1733,                         /* -mrecip */
  OPT_mrecip_ = 1734,                        /* -mrecip= */
  OPT_mrecord_mcount = 1735,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1736,                 /* -mrecord-return */
  OPT_mred_zone = 1737,                      /* -mred-zone */
  OPT_mregparm_ = 1738,                      /* -mregparm= */
  OPT_mrtd = 1739,                           /* -mrtd */
  OPT_mrtm = 1740,                           /* -mrtm */
  OPT_msahf = 1741,                          /* -msahf */
  OPT_msgx = 1742,                           /* -msgx */
  OPT_msha = 1743,                           /* -msha */
  OPT_mshstk = 1744,                         /* -mshstk */
  OPT_mskip_rax_setup = 1745,                /* -mskip-rax-setup */
  OPT_msoft_float = 1746,                    /* -msoft-float */
  OPT_msse = 1747,                           /* -msse */
  OPT_msse2 = 1748,                          /* -msse2 */
  OPT_msse2avx = 1749,                       /* -msse2avx */
  OPT_msse3 = 1750,                          /* -msse3 */
  OPT_msse4 = 1751,                          /* -msse4 */
  OPT_msse4_1 = 1752,                        /* -msse4.1 */
  OPT_msse4_2 = 1753,                        /* -msse4.2 */
  OPT_msse4a = 1754,                         /* -msse4a */
  /* OPT_msse5 = 1755, */                    /* -msse5 */
  OPT_msseregparm = 1756,                    /* -msseregparm */
  OPT_mssse3 = 1757,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1758,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1759, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1760,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1761, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1762,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1763,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1764,            /* -mstringop-strategy= */
  OPT_mstv = 1765,                           /* -mstv */
  OPT_mtbm = 1766,                           /* -mtbm */
  OPT_mtls_dialect_ = 1767,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1768,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1769,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1770,                         /* -mtune= */
  OPT_muclibc = 1771,                        /* -muclibc */
  OPT_mvaes = 1772,                          /* -mvaes */
  OPT_mveclibabi_ = 1773,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1774,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1775,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1776,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1777,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1778,                      /* -mwbnoinvd */
  OPT_mx32 = 1779,                           /* -mx32 */
  OPT_mxop = 1780,                           /* -mxop */
  OPT_mxsave = 1781,                         /* -mxsave */
  OPT_mxsavec = 1782,                        /* -mxsavec */
  OPT_mxsaveopt = 1783,                      /* -mxsaveopt */
  OPT_mxsaves = 1784,                        /* -mxsaves */
  OPT_n = 1785,                              /* -n */
  OPT_name_sort = 1786,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1787,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1788,              /* -no-integrated-cpp */
  OPT_no_pie = 1789,                         /* -no-pie */
  OPT_nocpp = 1790,                          /* -nocpp */
  OPT_nodefaultlibs = 1791,                  /* -nodefaultlibs */
  OPT_nolibc = 1792,                         /* -nolibc */
  OPT_nophoboslib = 1793,                    /* -nophoboslib */
  OPT_nostartfiles = 1794,                   /* -nostartfiles */
  OPT_nostdinc = 1795,                       /* -nostdinc */
  OPT_nostdinc__ = 1796,                     /* -nostdinc++ */
  OPT_nostdlib = 1797,                       /* -nostdlib */
  OPT_o = 1798,                              /* -o */
  OPT_objects = 1799,                        /* -objects */
  OPT_p = 1800,                              /* -p */
  OPT_pass_exit_codes = 1801,                /* -pass-exit-codes */
  /* OPT_pedantic = 1802, */                 /* -pedantic */
  OPT_pedantic_errors = 1803,                /* -pedantic-errors */
  OPT_pg = 1804,                             /* -pg */
  OPT_pie = 1805,                            /* -pie */
  OPT_pipe = 1806,                           /* -pipe */
  OPT_posix = 1807,                          /* -posix */
  OPT_print_file_name_ = 1808,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1809,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1810,          /* -print-multi-directory */
  OPT_print_multi_lib = 1811,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1812,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1813,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1814,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1815,               /* -print-prog-name= */
  OPT_print_search_dirs = 1816,              /* -print-search-dirs */
  OPT_print_sysroot = 1817,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1818,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1819,                    /* -print-value */
  OPT_profile = 1820,                        /* -profile */
  OPT_pthread = 1821,                        /* -pthread */
  OPT_quiet = 1822,                          /* -quiet */
  OPT_r = 1823,                              /* -r */
  OPT_rdynamic = 1824,                       /* -rdynamic */
  ...
  OPT_std_c__98 = 1858,                      /* -std=c++98 */
  OPT_std_c11 = 1859,                        /* -std=c11 */
  OPT_std_c17 = 1860,                        /* -std=c17 */
  /* OPT_std_c18 = 1861, */                  /* -std=c18 */
  /* OPT_std_c1x = 1862, */                  /* -std=c1x */
  OPT_std_c2x = 1863,                        /* -std=c2x */
  /* OPT_std_c89 = 1864, */                  /* -std=c89 */
  OPT_std_c90 = 1865,                        /* -std=c90 */
  OPT_std_c99 = 1866,                        /* -std=c99 */
  /* OPT_std_c9x = 1867, */                  /* -std=c9x */
  OPT_std_f2003 = 1868,                      /* -std=f2003 */
  OPT_std_f2008 = 1869,                      /* -std=f2008 */
  OPT_std_f2008ts = 1870,                    /* -std=f2008ts */
  OPT_std_f2018 = 1871,                      /* -std=f2018 */
  OPT_std_f95 = 1872,                        /* -std=f95 */
  OPT_std_gnu = 1873,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1874, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1875, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1876,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1877,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1878,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1879, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1880, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1881, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1882,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1883,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1884,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1885,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1886, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1887, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1888,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1889, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1890,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1891,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1892, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1893, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1894,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1895, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1896, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1897, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1898, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1899, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1900,                     /* -std=legacy */
  OPT_symbol_ = 1901,                        /* -symbol= */
  OPT_symbolic = 1902,                       /* -symbolic */
  OPT_t = 1903,                              /* -t */
  OPT_time = 1904,                           /* -time */
  OPT_time_ = 1905,                          /* -time= */
  OPT_tno_android_cc = 1906,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1907,                 /* -tno-android-ld */
  OPT_traditional = 1908,                    /* -traditional */
  OPT_traditional_cpp = 1909,                /* -traditional-cpp */
  OPT_tree_stats = 1910,                     /* -tree-stats */
  OPT_trigraphs = 1911,                      /* -trigraphs */
  OPT_type_stats = 1912,                     /* -type-stats */
  OPT_u = 1913,                              /* -u */
  OPT_undef = 1914,                          /* -undef */
  OPT_v = 1915,                              /* -v */
  OPT_version = 1916,                        /* -version */
  OPT_w = 1917,                              /* -w */
  OPT_wrapper = 1918,                        /* -wrapper */
  OPT_x = 1919,                              /* -x */
  OPT_z = 1920,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
